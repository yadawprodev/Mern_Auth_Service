      ...
      {userData && userData.username ? (
        <div className='relative' ref={menuRef}>
          ...
          <div
            ...
            className='flex w-8 h-8 justify-center items-center rounded-full bg-black text-white cursor-pointer'
          >
            {userData.username[0].toUpperCase()}
          </div>
          ...
          {showMenu && (
            <div className='absolute top-10 right-0 z-10 text-black rounded'>
              <ul className='list-none bg-gray-100 shadow-lg m-0 p-2 text-sm rounded-md min-w-35'>
                {!userData.isAccountVerified && (
                  <li
